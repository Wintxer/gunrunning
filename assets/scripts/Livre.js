...
renderer.setSize(window.innerWidth / 2.4, window.innerHeight / 1.39);
document.querySelector(".livre").appendChild(renderer.domElement);
...
loader.load(
  // resource URL
  '../assets/models/fbx/bookTexture.fbx',
