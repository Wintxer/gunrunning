...
renderer.setSize(window.innerWidth / 2.4, window.innerHeight / 1.5);
document.querySelector(".cadenas").appendChild(renderer.domElement);
...
loader.load(
  // resource URL
  '../assets/models/fbx/cadenasTexture.fbx',
